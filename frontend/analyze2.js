...
async function run() {
    ...
    console.log('SALDO TOTAL:', result);
    console.log('\n--- DETALLE DE MOVIMIENTOS A/DESDE EFECTIVO ---');
    console.log(JSON.stringify(data.filter(m => m.cuenta_destino === 'Efectivo' || m.cuenta_origen === 'Efectivo'), null, 2));
}
