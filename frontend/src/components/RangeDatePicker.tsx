...
export const RangeDatePicker: React.FC<RangeDatePickerProps> = ({ isOpen, startDate, endDate, onApply, onCancel }) => {
    ...
    return (
        <div 
            className={`absolute top-full right-0 mt-3 bg-white/70 backdrop-blur-xl rounded-[24px] p-5 shadow-[0_10px_40px_rgba(0,0,0,0.1)] border border-white/40 z-[100] transition-all duration-200 origin-top-right w-[480px]
