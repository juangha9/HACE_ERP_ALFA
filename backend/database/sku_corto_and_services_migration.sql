-- =========================================================================
-- MIGRACIÓN SUPABASE: SKU CORTO, SERVICIOS Y APROBACIÓN DE DESCUENTOS
...
-- 2. Tabla de auditoría para cambios en el catálogo de productos
...
-- Habilitar RLS en la nueva tabla de auditoría
ALTER TABLE catalog_products_audit_log ENABLE ROW LEVEL SECURITY;

-- Crear política permisiva (desarrollo interno)
DO $$
BEGIN
    IF NOT EXISTS (
...
-- Crear índice para búsquedas rápidas de solicitudes pendientes
