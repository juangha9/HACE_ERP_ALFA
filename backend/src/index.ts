    ...
    try {
      ...
      if (request.method === 'POST' && url.pathname === '/api/roles') {
        try {
          ...
          const allowedFields = ['nombre_cargo', 'area', 'reporta_a', 'supervisa_a', 'proposito', 'nombres', 'horario', 'rango_salarial', 'sueldo', 'dotacion', 'parent_id', 'dni', 'jerarquia', 'relacion_funcional', 'tipo_relacion'];
